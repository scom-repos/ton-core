...
export declare type OutActionExtended = OutActionSetIsPublicKeyEnabled | OutActionAddExtension | OutActionRemoveExtension;
export declare type OutActionWalletV5 = OutActionExtended | OutActionSendMsg;
