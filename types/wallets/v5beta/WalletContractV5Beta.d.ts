...
export declare type WalletV5BetaBasicSendArgs = {
    seqno: number;
    timeout?: Maybe<number>;
};
export declare type WalletV5BetaSendArgsSigned = WalletV5BetaBasicSendArgs & SendArgsSigned & {
    authType?: 'external' | 'internal';
};
export declare type WalletV5BetaSendArgsSignable = WalletV5BetaBasicSendArgs & SendArgsSignable & {
    authType?: 'external' | 'internal';
};
export declare type WalletV5BetaSendArgsExtensionAuth = WalletV5BetaBasicSendArgs & {
    authType: 'extension';
};
export declare type WalletV5BetaSendArgs = WalletV5BetaSendArgsSigned | WalletV5BetaSendArgsSignable | WalletV5BetaSendArgsExtensionAuth;
export declare type WalletV5BetaPackedCell<T> = T extends WalletV5BetaSendArgsSignable ? Promise<Cell> : Cell;
/**
 * @deprecated
