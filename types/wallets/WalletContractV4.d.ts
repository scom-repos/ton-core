...
export declare type WalletV4BasicSendArgs = {
    seqno: number;
    messages: MessageRelaxed[];
    sendMode?: Maybe<SendMode>;
    timeout?: Maybe<number>;
};
export declare type Wallet4SendArgsSigned = WalletV4BasicSendArgs & SendArgsSigned;
export declare type Wallet4SendArgsSignable = WalletV4BasicSendArgs & SendArgsSignable;
