...
export declare class Slice {
     ...
     */
    loadMaybeUint(bits: number): number;
    /**
     * Load maybe uint
     * @param bits number of bits to read
     * @returns uint value or null
     */
    loadMaybeUintBig(bits: number): bigint;
    /**
     * Load int
     * @param bits number of bits to read
     * @returns int value
     ...
     * @returns uint value or null
     */
    loadMaybeInt(bits: number): number;
    /**
     * Load maybe uint
     * @param bits number of bits to read
     * @returns uint value or null
     */
    loadMaybeIntBig(bits: number): bigint;
    /**
     * Load varuint
     ...
     */
    loadMaybeAddress(): import("..").Address;
    /**
     ...
     */
    loadMaybeExternalAddress(): import("..").ExternalAddress;
    /**
     * Load address
     * @returns Address, ExternalAddress or null
     */
    loadAddressAny(): import("..").Address | import("..").ExternalAddress;
    /**
     * Load reference
     * @returns Cell
     */
